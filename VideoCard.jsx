...
function VideoCard({ videoId, title, channel, user, description }) {
  ...
  return (
    <div style={{
      ...
      <h2>{title}</h2>
      <p style={{ fontStyle: "italic", color: "#555" }}>Canal: {channel}</p>
      ...
      <div style={{ marginTop: "15px" }}>
        ...
        <div style={{ marginBottom: "5px" }}>
          ✔ Verdadero: {percent(votes.verdadero)}%
          <div style={{
            background: "#eee",
            width: "100%",
            height: "10px",
